...
namespace simplecpp {
struct Position {
    // @adi - My thoughts are these can be integral types, Yes it loses precision
    double x, y;
...
struct Color {
    // NOTE: To directly pass these values to OpenGL, use glColor3ub, not any
    // other, glColor3b or 3i etc. (they take different range of values)
    u8 r = 127;
    u8 g = 127;
    u8 b = 127;
